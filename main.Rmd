...
<!--chapter:end:02-kalkulaator.Rmd-->
...
Kui sa soovid oluliselt ohverdada reprodutseeritavust installi RStudio addin: "Gotta read em all R".
...
<!--chapter:end:05-funktsioonid.Rmd-->
