...
1. googelda "install R" ja installi viimane versioon
2. googelda "install RStudio" ja installi viimane versioon (mõlemad on väga lihtsad installid)
3. ava RStudio (R ise töötab taustal ja sa ei pea seda kunagi ise avama)
4. ava "File/New File/R script"
5. ava "File/Save as" ja nimeta/salvesta oma skript kataloogi, mille sa selle kursuse jaoks tegid.

###Sinu kataloogi struktuur:

**R_kursus2017/data; /scripts; /figs; /misc**

**data** folderisse lähevad ainult algandmed (.csv või .xlsx laiendiga meie puhul).

**scripts** folderisse läheb sinu kirjutatud kood .R või .Rmd laienditega failides.
