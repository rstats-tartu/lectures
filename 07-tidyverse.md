...
#>       V9    V8    V5     V2    V6
#>    <dbl> <dbl> <dbl>  <dbl> <dbl>
#> 1 0.505  0.785 0.698 0.534  0.268
#> 2 0.620  0.300 0.377 0.130  0.693
#> 3 0.291  0.236 0.390 0.552  0.895
#> 4 0.0706 0.510 0.214 0.327  0.307
#> 5 0.219  0.169 0.252 0.0742 0.915
#> 6 0.520  0.399 0.527 0.168  0.306
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>       V9    V8     V7    V6
#>    <dbl> <dbl>  <dbl> <dbl>
#> 1 0.505  0.785 0.0887 0.268
#> 2 0.620  0.300 0.0376 0.693
#> 3 0.291  0.236 0.672  0.895
#> 4 0.0706 0.510 0.472  0.307
#> 5 0.219  0.169 0.916  0.915
#> 6 0.520  0.399 0.646  0.306
#> # ... with 4 more rows
