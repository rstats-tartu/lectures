...
#>       V9    V8     V5    V2     V6
#>    <dbl> <dbl>  <dbl> <dbl>  <dbl>
#> 1 0.166  0.247 0.729  0.820 0.574 
#> 2 0.103  0.930 0.729  0.881 0.746 
#> 3 0.270  0.227 0.328  0.660 0.419 
#> 4 0.874  0.397 0.580  0.897 0.515 
#> 5 0.194  0.757 0.982  0.595 0.0899
#> 6 0.0448 0.433 0.0436 0.862 0.450 
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>       V9    V8     V7     V6
#>    <dbl> <dbl>  <dbl>  <dbl>
#> 1 0.166  0.247 0.151  0.574 
#> 2 0.103  0.930 0.954  0.746 
#> 3 0.270  0.227 0.206  0.419 
#> 4 0.874  0.397 0.619  0.515 
#> 5 0.194  0.757 0.856  0.0899
#> 6 0.0448 0.433 0.0979 0.450 
#> # ... with 4 more rows
