...
#>       V9     V8    V5     V2    V6
#>    <dbl>  <dbl> <dbl>  <dbl> <dbl>
#> 1 0.522  0.470  0.387 0.888  0.783
#> 2 0.0645 0.120  0.436 0.185  0.504
#> 3 0.283  0.638  0.533 0.774  0.662
#> 4 0.294  0.0203 0.490 0.0265 0.324
#> 5 0.664  0.614  0.247 0.845  0.183
#> 6 0.492  0.0482 0.752 0.264  0.889
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>       V9     V8     V7    V6
#>    <dbl>  <dbl>  <dbl> <dbl>
#> 1 0.522  0.470  0.248  0.783
#> 2 0.0645 0.120  0.113  0.504
#> 3 0.283  0.638  0.564  0.662
#> 4 0.294  0.0203 0.0452 0.324
#> 5 0.664  0.614  0.670  0.183
#> 6 0.492  0.0482 0.228  0.889
#> # ... with 4 more rows
