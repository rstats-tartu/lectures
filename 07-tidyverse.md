...
#>      V9    V8    V5    V2    V6
#>   <dbl> <dbl> <dbl> <dbl> <dbl>
#> 1 0.304 0.838 0.655 0.833 0.228
#> 2 0.778 0.757 0.484 0.510 0.658
#> 3 0.122 0.792 0.237 0.215 0.728
#> 4 0.383 0.975 0.602 0.190 0.591
#> 5 0.289 0.811 0.343 0.770 0.602
#> 6 0.477 0.524 0.703 0.699 0.762
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>      V9    V8     V7    V6
#>   <dbl> <dbl>  <dbl> <dbl>
#> 1 0.304 0.838 0.0294 0.228
#> 2 0.778 0.757 0.0666 0.658
#> 3 0.122 0.792 0.0180 0.728
#> 4 0.383 0.975 0.644  0.591
#> 5 0.289 0.811 0.0939 0.602
#> 6 0.477 0.524 0.430  0.762
#> # ... with 4 more rows
