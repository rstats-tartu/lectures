...
#>       V9    V8     V5    V2    V6
#>    <dbl> <dbl>  <dbl> <dbl> <dbl>
#> 1 0.480  0.396 0.0901 0.834 0.298
#> 2 0.821  0.377 0.492  0.471 0.467
#> 3 0.0493 0.330 0.335  0.947 0.758
#> 4 0.655  0.174 0.0382 0.569 0.704
#> 5 0.444  0.673 0.874  0.445 0.299
#> 6 0.845  0.554 0.396  0.515 0.722
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>       V9    V8    V7    V6
#>    <dbl> <dbl> <dbl> <dbl>
#> 1 0.480  0.396 0.828 0.298
#> 2 0.821  0.377 0.144 0.467
#> 3 0.0493 0.330 0.614 0.758
#> 4 0.655  0.174 0.662 0.704
#> 5 0.444  0.673 0.259 0.299
#> 6 0.845  0.554 0.107 0.722
#> # ... with 4 more rows
