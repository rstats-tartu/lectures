...
#>      V9    V8    V5    V2    V6
#>   <dbl> <dbl> <dbl> <dbl> <dbl>
#> 1 0.580 0.777 0.179 0.797 0.863
#> 2 0.844 0.104 0.592 0.173 0.236
#> 3 0.458 0.170 0.814 0.229 0.821
#> 4 0.133 0.590 0.458 0.454 0.596
#> 5 0.452 0.901 0.244 0.364 0.711
#> 6 0.311 0.438 0.862 0.176 0.122
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>      V9    V8    V7    V6
#>   <dbl> <dbl> <dbl> <dbl>
#> 1 0.580 0.777 0.250 0.863
#> 2 0.844 0.104 0.437 0.236
#> 3 0.458 0.170 0.940 0.821
#> 4 0.133 0.590 0.598 0.596
#> 5 0.452 0.901 0.393 0.711
#> 6 0.311 0.438 0.861 0.122
#> # ... with 4 more rows
