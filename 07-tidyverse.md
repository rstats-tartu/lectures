...
#>       V9    V8     V5     V2     V6
#>    <dbl> <dbl>  <dbl>  <dbl>  <dbl>
#> 1 0.661  0.806 0.0119 0.155  0.463 
#> 2 0.857  0.511 0.239  0.0305 0.342 
#> 3 0.870  0.468 0.931  0.913  0.315 
#> 4 0.615  0.230 0.260  0.139  0.110 
#> 5 0.811  0.229 0.259  0.0478 0.0557
#> 6 0.0701 0.222 0.643  0.886  0.157 
#> # … with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>       V9    V8     V7     V6
#>    <dbl> <dbl>  <dbl>  <dbl>
#> 1 0.661  0.806 0.451  0.463 
#> 2 0.857  0.511 0.0937 0.342 
#> 3 0.870  0.468 0.792  0.315 
#> 4 0.615  0.230 0.195  0.110 
#> 5 0.811  0.229 0.801  0.0557
#> 6 0.0701 0.222 0.755  0.157 
#> # … with 4 more rows
