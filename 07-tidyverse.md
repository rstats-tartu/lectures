...
#>       V9    V8     V5    V2    V6
#>    <dbl> <dbl>  <dbl> <dbl> <dbl>
#> 1 0.215  0.174 0.130  0.445 0.123
#> 2 0.0433 0.783 0.590  0.851 0.656
#> 3 0.476  0.576 0.308  0.278 0.492
#> 4 0.857  0.282 0.989  0.659 0.857
#> 5 0.790  0.879 0.483  0.894 0.899
#> 6 0.377  0.343 0.0616 0.254 0.124
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>       V9    V8    V7    V6
#>    <dbl> <dbl> <dbl> <dbl>
#> 1 0.215  0.174 0.696 0.123
#> 2 0.0433 0.783 0.493 0.656
#> 3 0.476  0.576 0.983 0.492
#> 4 0.857  0.282 0.554 0.857
#> 5 0.790  0.879 0.272 0.899
#> 6 0.377  0.343 0.512 0.124
#> # ... with 4 more rows
