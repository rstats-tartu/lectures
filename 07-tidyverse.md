...
#>      V9    V8    V5     V2     V6
#>   <dbl> <dbl> <dbl>  <dbl>  <dbl>
#> 1 0.671 0.838 0.577 0.0568 0.854 
#> 2 0.452 0.419 0.290 0.722  0.807 
#> 3 0.718 0.812 0.967 0.538  0.0285
#> 4 0.199 0.446 0.959 0.523  0.263 
#> 5 0.798 0.351 0.571 0.450  0.200 
#> 6 0.911 0.505 0.527 0.157  0.186 
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>      V9    V8      V7     V6
#>   <dbl> <dbl>   <dbl>  <dbl>
#> 1 0.671 0.838 0.0252  0.854 
#> 2 0.452 0.419 0.544   0.807 
#> 3 0.718 0.812 0.328   0.0285
#> 4 0.199 0.446 0.746   0.263 
#> 5 0.798 0.351 0.199   0.200 
#> 6 0.911 0.505 0.00245 0.186 
#> # ... with 4 more rows
