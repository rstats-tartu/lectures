...
#>       V9     V8      V5    V2    V6
#>    <dbl>  <dbl>   <dbl> <dbl> <dbl>
#> 1 0.445  0.558  0.671   0.160 0.737
#> 2 0.482  0.0382 0.372   0.882 0.778
#> 3 0.0203 0.148  0.00865 0.795 0.490
#> 4 0.779  0.953  0.159   0.609 0.146
#> 5 0.853  0.995  0.473   0.769 0.840
#> 6 0.575  0.936  0.471   0.287 0.571
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>       V9     V8     V7    V6
#>    <dbl>  <dbl>  <dbl> <dbl>
#> 1 0.445  0.558  0.294  0.737
#> 2 0.482  0.0382 0.725  0.778
#> 3 0.0203 0.148  0.0614 0.490
#> 4 0.779  0.953  0.508  0.146
#> 5 0.853  0.995  0.236  0.840
#> 6 0.575  0.936  0.636  0.571
#> # ... with 4 more rows
