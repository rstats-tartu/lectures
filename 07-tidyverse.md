...
#>       V9    V8     V5    V2     V6
#>    <dbl> <dbl>  <dbl> <dbl>  <dbl>
#> 1 0.136  0.720 0.0686 0.245 0.336 
#> 2 0.0123 0.767 0.0483 0.444 0.0156
#> 3 0.384  0.442 0.120  0.518 0.840 
#> 4 0.175  0.351 0.857  0.296 0.0885
#> 5 0.408  0.507 0.569  0.713 0.445 
#> 6 0.832  0.841 0.465  0.941 0.422 
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>       V9    V8    V7     V6
#>    <dbl> <dbl> <dbl>  <dbl>
#> 1 0.136  0.720 0.756 0.336 
#> 2 0.0123 0.767 0.168 0.0156
#> 3 0.384  0.442 0.519 0.840 
#> 4 0.175  0.351 0.958 0.0885
#> 5 0.408  0.507 0.639 0.445 
#> 6 0.832  0.841 0.510 0.422 
#> # ... with 4 more rows
