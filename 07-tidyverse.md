...
#>      V9    V8     V5    V2    V6
#>   <dbl> <dbl>  <dbl> <dbl> <dbl>
#> 1 0.859 0.618 0.317  0.978 0.648
#> 2 0.684 0.399 0.853  0.528 0.532
#> 3 0.535 0.176 0.597  0.823 0.958
#> 4 0.803 0.606 0.203  0.421 0.962
#> 5 0.829 0.562 0.0161 0.680 0.617
#> 6 0.284 0.738 0.696  0.580 0.872
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>      V9    V8    V7    V6
#>   <dbl> <dbl> <dbl> <dbl>
#> 1 0.859 0.618 0.174 0.648
#> 2 0.684 0.399 0.735 0.532
#> 3 0.535 0.176 0.900 0.958
#> 4 0.803 0.606 0.786 0.962
#> 5 0.829 0.562 0.509 0.617
#> 6 0.284 0.738 0.748 0.872
#> # ... with 4 more rows
