...
#>       V9    V8     V5      V2    V6
#>    <dbl> <dbl>  <dbl>   <dbl> <dbl>
#> 1 0.720  0.881 0.589  0.319   0.798
#> 2 0.398  0.557 0.0971 0.538   0.317
#> 3 0.0194 0.465 0.0642 0.392   0.273
#> 4 0.655  0.723 0.203  0.828   0.532
#> 5 0.0248 0.827 0.0173 0.961   0.122
#> 6 0.415  0.827 0.434  0.00439 0.213
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>       V9    V8    V7    V6
#>    <dbl> <dbl> <dbl> <dbl>
#> 1 0.720  0.881 0.877 0.798
#> 2 0.398  0.557 0.170 0.317
#> 3 0.0194 0.465 0.916 0.273
#> 4 0.655  0.723 0.399 0.532
#> 5 0.0248 0.827 0.955 0.122
#> 6 0.415  0.827 0.339 0.213
#> # ... with 4 more rows
