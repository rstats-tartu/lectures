...
#>      V9    V8    V5     V2     V6
#>   <dbl> <dbl> <dbl>  <dbl>  <dbl>
#> 1 0.466 0.864 0.160 0.0751 0.0911
#> 2 0.137 0.209 0.582 0.430  0.297 
#> 3 0.206 0.899 0.296 0.841  0.229 
#> 4 0.926 0.691 0.221 0.351  0.135 
#> 5 0.505 0.688 0.586 0.801  0.153 
#> 6 0.331 0.869 0.304 0.500  0.774 
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>      V9    V8    V7     V6
#>   <dbl> <dbl> <dbl>  <dbl>
#> 1 0.466 0.864 0.868 0.0911
#> 2 0.137 0.209 0.229 0.297 
#> 3 0.206 0.899 0.193 0.229 
#> 4 0.926 0.691 0.876 0.135 
#> 5 0.505 0.688 0.499 0.153 
#> 6 0.331 0.869 0.660 0.774 
#> # ... with 4 more rows
