...
#>       V9    V8     V5     V2    V6
#>    <dbl> <dbl>  <dbl>  <dbl> <dbl>
#> 1 0.0916 0.306 0.0437 0.739  0.491
#> 2 0.793  0.137 0.0755 0.810  0.662
#> 3 0.635  0.276 0.663  0.0827 0.729
#> 4 0.334  0.457 0.403  0.551  0.591
#> 5 0.475  0.244 0.369  0.293  0.667
#> 6 0.680  0.854 0.480  0.582  0.602
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>       V9    V8     V7    V6
#>    <dbl> <dbl>  <dbl> <dbl>
#> 1 0.0916 0.306 0.694  0.491
#> 2 0.793  0.137 0.0663 0.662
#> 3 0.635  0.276 0.574  0.729
#> 4 0.334  0.457 0.756  0.591
#> 5 0.475  0.244 0.288  0.667
#> 6 0.680  0.854 0.797  0.602
#> # ... with 4 more rows
