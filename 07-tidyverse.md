...
#>      V9    V8    V5    V2     V6
#>   <dbl> <dbl> <dbl> <dbl>  <dbl>
#> 1 0.787 0.741 0.948 0.590 0.791 
#> 2 0.911 0.419 0.583 0.913 0.656 
#> 3 0.564 0.172 0.647 0.409 0.827 
#> 4 0.195 0.582 0.468 0.936 0.0821
#> 5 0.927 0.813 0.378 0.842 0.393 
#> 6 0.732 0.642 0.934 0.187 0.0443
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>      V9    V8    V7     V6
#>   <dbl> <dbl> <dbl>  <dbl>
#> 1 0.787 0.741 0.157 0.791 
#> 2 0.911 0.419 0.108 0.656 
#> 3 0.564 0.172 0.362 0.827 
#> 4 0.195 0.582 0.348 0.0821
#> 5 0.927 0.813 0.461 0.393 
#> 6 0.732 0.642 0.727 0.0443
#> # ... with 4 more rows
