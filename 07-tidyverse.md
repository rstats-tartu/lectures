...
#>       V9    V8    V5     V2     V6
#>    <dbl> <dbl> <dbl>  <dbl>  <dbl>
#> 1 0.353  0.453 0.971 0.614  0.622 
#> 2 0.851  0.835 0.264 0.0793 0.343 
#> 3 0.948  0.500 0.291 0.949  0.386 
#> 4 0.0778 0.568 0.215 0.685  0.992 
#> 5 0.320  0.860 0.912 0.745  0.0920
#> 6 0.191  0.536 0.789 0.410  0.364 
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>       V9    V8     V7     V6
#>    <dbl> <dbl>  <dbl>  <dbl>
#> 1 0.353  0.453 0.323  0.622 
#> 2 0.851  0.835 0.172  0.343 
#> 3 0.948  0.500 0.687  0.386 
#> 4 0.0778 0.568 0.335  0.992 
#> 5 0.320  0.860 0.0718 0.0920
#> 6 0.191  0.536 0.0109 0.364 
#> # ... with 4 more rows
