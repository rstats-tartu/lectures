...
#>      V9    V8    V5       V2      V6
#>   <dbl> <dbl> <dbl>    <dbl>   <dbl>
#> 1 0.769 0.636 0.562 0.698    0.0957 
#> 2 0.757 0.219 0.530 0.508    0.00984
#> 3 0.655 0.414 0.319 0.0941   0.797  
#> 4 0.493 0.974 0.866 0.266    0.283  
#> 5 0.109 0.372 0.710 0.000456 0.803  
#> 6 0.844 0.458 0.209 0.425    0.838  
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>      V9    V8     V7      V6
#>   <dbl> <dbl>  <dbl>   <dbl>
#> 1 0.769 0.636 0.279  0.0957 
#> 2 0.757 0.219 0.432  0.00984
#> 3 0.655 0.414 0.0418 0.797  
#> 4 0.493 0.974 0.589  0.283  
#> 5 0.109 0.372 0.726  0.803  
#> 6 0.844 0.458 0.156  0.838  
#> # ... with 4 more rows
