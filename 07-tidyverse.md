...
#>       V9    V8     V5    V2    V6
#>    <dbl> <dbl>  <dbl> <dbl> <dbl>
#> 1 0.852  0.795 0.153  0.146 0.818
#> 2 0.0927 0.755 0.0388 0.872 0.616
#> 3 0.352  0.190 0.726  0.691 0.165
#> 4 0.561  0.512 0.413  0.598 0.163
#> 5 0.688  0.665 0.834  0.538 0.194
#> 6 0.809  0.229 0.365  0.833 0.152
#> # … with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>       V9    V8     V7    V6
#>    <dbl> <dbl>  <dbl> <dbl>
#> 1 0.852  0.795 0.475  0.818
#> 2 0.0927 0.755 0.0292 0.616
#> 3 0.352  0.190 0.392  0.165
#> 4 0.561  0.512 0.756  0.163
#> 5 0.688  0.665 0.475  0.194
#> 6 0.809  0.229 0.668  0.152
#> # … with 4 more rows
