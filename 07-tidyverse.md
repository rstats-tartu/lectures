...
#>      V9     V8     V5     V2    V6
#>   <dbl>  <dbl>  <dbl>  <dbl> <dbl>
#> 1 0.986 0.396  0.0369 0.284  0.414
#> 2 0.781 0.230  0.699  0.0952 0.778
#> 3 0.761 0.574  0.606  0.698  0.403
#> 4 0.955 0.632  0.461  0.525  0.379
#> 5 0.695 0.0232 0.628  0.653  0.264
#> 6 0.676 0.758  0.646  0.574  0.968
#> # … with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>      V9     V8    V7    V6
#>   <dbl>  <dbl> <dbl> <dbl>
#> 1 0.986 0.396  0.557 0.414
#> 2 0.781 0.230  0.205 0.778
#> 3 0.761 0.574  0.795 0.403
#> 4 0.955 0.632  0.624 0.379
#> 5 0.695 0.0232 0.303 0.264
#> 6 0.676 0.758  0.674 0.968
#> # … with 4 more rows
