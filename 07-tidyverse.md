...
#>   <fct>          <dbl>       <dbl>        <dbl>
#> 1 setosa          5.10        3.50         1.40
#> 2 setosa          4.90        3.00         1.40
#> 3 setosa          4.70        3.20         1.30
#> 4 setosa          4.60        3.10         1.50
#> 5 setosa          5.00        3.60         1.40
#> 6 setosa          5.40        3.90         1.70
...
#>       V9    V8      V5     V2    V6
#>    <dbl> <dbl>   <dbl>  <dbl> <dbl>
#> 1 0.0836 0.400 0.295   0.386  0.615
#> 2 0.505  0.285 0.443   0.0188 0.767
#> 3 0.0876 0.836 0.698   0.508  0.772
#> 4 0.0211 0.287 0.188   0.525  0.901
#> 5 0.0678 0.419 0.00769 0.0784 0.547
#> 6 0.969  0.251 0.359   0.758  0.600
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>       V9    V8     V7    V6
#>    <dbl> <dbl>  <dbl> <dbl>
#> 1 0.0836 0.400 0.668  0.615
#> 2 0.505  0.285 0.656  0.767
#> 3 0.0876 0.836 0.669  0.772
#> 4 0.0211 0.287 0.290  0.901
#> 5 0.0678 0.419 0.218  0.547
#> 6 0.969  0.251 0.0488 0.600
#> # ... with 4 more rows
...
#>          <dbl>       <dbl>        <dbl>       <dbl>
#> 1         4.40        2.90         1.40       0.200
#> 2         4.30        3.00         1.10       0.100
#> 3         4.40        3.00         1.30       0.200
#> 4         4.40        3.20         1.30       0.200
...
#> 3         4.40        3.00         1.30       0.200
#> 4         4.40        3.20         1.30       0.200
#> 5         7.00        3.20         4.70       1.40 
#> 6         6.40        3.20         4.50       1.50 
...
#> 2         6.40        3.20         4.50        1.50
#> 3         6.90        3.10         4.90        1.50
#> 4         5.50        2.30         4.00        1.30
#> 5         6.50        2.80         4.60        1.50
#> 6         5.70        2.80         4.50        1.30
