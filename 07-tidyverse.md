...
#>       V9     V8     V5    V2    V6
#>    <dbl>  <dbl>  <dbl> <dbl> <dbl>
#> 1 0.924  0.774  0.921  0.277 0.829
#> 2 0.402  0.413  0.609  0.303 0.534
#> 3 0.721  0.949  0.630  0.553 0.519
#> 4 0.137  0.0465 0.339  0.838 0.952
#> 5 0.975  0.448  0.0623 0.709 0.193
#> 6 0.0654 0.846  0.796  0.896 0.782
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>       V9     V8    V7    V6
#>    <dbl>  <dbl> <dbl> <dbl>
#> 1 0.924  0.774  0.982 0.829
#> 2 0.402  0.413  0.142 0.534
#> 3 0.721  0.949  0.416 0.519
#> 4 0.137  0.0465 0.123 0.952
#> 5 0.975  0.448  0.936 0.193
#> 6 0.0654 0.846  0.130 0.782
#> # ... with 4 more rows
