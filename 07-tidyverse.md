...
#>      V9     V8    V5      V2    V6
#>   <dbl>  <dbl> <dbl>   <dbl> <dbl>
#> 1 0.320 0.0897 0.905 0.00443 0.607
#> 2 0.604 0.543  0.888 0.393   0.861
#> 3 0.207 0.214  0.433 0.646   0.112
#> 4 0.919 0.499  0.851 0.337   0.302
#> 5 0.683 0.928  0.410 0.137   0.116
#> 6 0.426 0.331  0.864 0.0119  0.930
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>      V9     V8    V7    V6
#>   <dbl>  <dbl> <dbl> <dbl>
#> 1 0.320 0.0897 0.862 0.607
#> 2 0.604 0.543  0.150 0.861
#> 3 0.207 0.214  0.759 0.112
#> 4 0.919 0.499  0.484 0.302
#> 5 0.683 0.928  0.571 0.116
#> 6 0.426 0.331  0.929 0.930
#> # ... with 4 more rows
