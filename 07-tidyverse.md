...
#>       V9     V8    V5    V2    V6
#>    <dbl>  <dbl> <dbl> <dbl> <dbl>
#> 1 0.727  0.414  0.542 0.373 0.281
#> 2 0.885  0.271  0.524 0.929 0.339
#> 3 0.0181 0.756  0.820 0.179 0.549
#> 4 0.669  0.0279 0.560 0.407 0.206
#> 5 0.239  0.913  0.411 0.986 0.755
#> 6 0.0368 0.386  0.974 0.426 0.675
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>       V9     V8    V7    V6
#>    <dbl>  <dbl> <dbl> <dbl>
#> 1 0.727  0.414  0.720 0.281
#> 2 0.885  0.271  0.775 0.339
#> 3 0.0181 0.756  0.857 0.549
#> 4 0.669  0.0279 0.532 0.206
#> 5 0.239  0.913  0.158 0.755
#> 6 0.0368 0.386  0.613 0.675
#> # ... with 4 more rows
