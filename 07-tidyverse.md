...
#>      V9    V8    V5    V2      V6
#>   <dbl> <dbl> <dbl> <dbl>   <dbl>
#> 1 0.986 0.479 0.237 0.382 0.839  
#> 2 0.143 0.645 0.574 0.176 0.303  
#> 3 0.741 0.425 0.363 0.458 0.295  
#> 4 0.310 0.525 0.178 0.361 0.596  
#> 5 0.382 0.959 0.703 0.187 0.00755
#> 6 0.892 0.142 0.203 0.793 0.387  
#> # ... with 4 more rows
select(dat, num_range("V", 9:6))
#> # A tibble: 10 x 4
#>      V9    V8        V7      V6
#>   <dbl> <dbl>     <dbl>   <dbl>
#> 1 0.986 0.479 0.383     0.839  
#> 2 0.143 0.645 0.122     0.303  
#> 3 0.741 0.425 0.689     0.295  
#> 4 0.310 0.525 0.705     0.596  
#> 5 0.382 0.959 0.0000849 0.00755
#> 6 0.892 0.142 0.812     0.387  
#> # ... with 4 more rows
