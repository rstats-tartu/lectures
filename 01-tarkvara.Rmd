...
2. Move all folders from your old R version to new R version.
...
3. Update the moved packages

Run the following command. Type ‘y’ for every question that popped up.

update.packages(checkBuilt=TRUE)

4. Type the following command in R to check if everything went well
