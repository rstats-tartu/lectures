...
Kui Rmd fail tõsta näiteks projekti alamkataloogi "projroot/analyses/", siis hakkab `knitr::knit()` otsima faile, mis tegelikult asuvad "projroot/data/" kataloogis, kataloogist "projroot/analyses/data/".  
...
<!-- "knitr" võimaldab R skripte osakaupa Rmd failist käivitada.  -->
<!-- Selleks peab R skriptis  evalueeritava koodi alguse markeerima `# @knitr minu-koodi-id`. -->
...
<!-- Ja Rmd failis tuleb kõigepealt eraldi koodi _chunk_-is see skript ("src/minu-skript.R") sisse lugeda: -->

<!-- ``` -->
<!-- ```{r} -->
<!-- library(knitr) -->
<!-- read_chunk("src/minu-skript.R") -->
<!-- ``` -->
<!-- ``` -->

<!-- Seejärel käivitatakse kood mis algab peale `# @knitr normhist` markeeringut lisades viite uues `chunk`-is sellele koodile. -->
<!-- ``` -->
<!-- ```{r normhist} -->
