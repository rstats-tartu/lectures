...
```{r, echo=FALSE, fig.cap="RStudio aken, mis on jagatud neljaks vaikimisi alaks. Vasakul üleval, koodi aken. Vasakul all, R konsool. Paremal üleval, töökeskonna aken, erinevate sakkidega. Paremal all, failid, plotid, help."}
