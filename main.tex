...
\section*{Haara kannel, Vanemuine!}\label{haara-kannel-vanemuine}
\addcontentsline{toc}{section}{Haara kannel, Vanemuine!}
...
\section{Sissejuhatus}\label{intro}
...
\section{Tarkvaratööriistad}\label{tools}

\subsection{Installeeri vajalikud
...
\subsection{Loo GitHubi konto}\label{loo-githubi-konto}
...
\subsection{Loo uus R projekt}\label{loo-uus-r-projekt}
...
\subsection{\texorpdfstring{Git \emph{Merge}
...
\subsection{R projekti kataloogi soovitatav minimaalne
...
\subsection{Pakettide installeerimine}\label{libs}
...
\subsection{R repositooriumid}\label{r-repositooriumid}
...
\section{R on kalkulaator}\label{calc}
...
\subsection{Sama koodi saab kirjutada neljal
...
\subsection{Nimede vorm}\label{nimede-vorm}
...
\subsection{Andmete tüübid}\label{andmete-tuubid}
...
\subsubsection{\texorpdfstring{Uus vektor: \texttt{seq()} ja
...
\subsubsection{Tehted arvuliste
...
\begin{verbatim}
## [[1]]
## [1] 0.2376 0.5237 0.6156 0.7034 0.2578
## 
## [[2]]
##        a       b
## 1 0.2376  0.1841
...
\subsection{data frame ja tibble}\label{data-frame-ja-tibble}
...
\subsubsection{Ühendame kaks tibblet rea
...
\subsubsection{Andmeraamide salvestamine
...
\subsection{Tabelit sisse lugedes vaata üle
...
\subsection{Indekseerimine}\label{indekseerimine}
...
\subsubsection{Vektorid ja nende indeksid on
...
\subsubsection{Andmeraamid ja maatriksid on kahedimensionaalsed, nagu ka
nende
...
\subsubsection{Listide indekseerimine}\label{listide-indekseerimine}
...
\section{Regular expression ja find \& replace}\label{regex}
...
\section{Funktsioonid on R keele verbid}\label{funs}
...
\subsection{Kirjutame R funktsiooni}\label{kirjutame-r-funktsiooni}
...
\subsubsection{Tabeli dimensioonide muutmine (pikk ja lai
...
\subsection{dplyr ja selle viis verbi}\label{dplyr-ja-selle-viis-verbi}
...
\subsubsection{\texorpdfstring{\texttt{select()}
...
##        V9       V8       V5     V2      V6
##     <dbl>    <dbl>    <dbl>  <dbl>   <dbl>
##  1 0.6288 0.240864 0.818923 0.5815 0.04952
##  2 0.8961 0.936968 0.411140 0.7829 0.55065
##  3 0.8091 0.453242 0.134573 0.5896 0.84749
##  4 0.7617 0.006659 0.146492 0.1318 0.59532
##  5 0.9758 0.131051 0.006327 0.8297 0.19016
##  6 0.8193 0.519675 0.058168 0.4657 0.68993
##  7 0.2888 0.966405 0.289861 0.4289 0.29977
##  8 0.0981 0.673018 0.228936 0.4834 0.09216
##  9 0.3256 0.777429 0.855171 0.1098 0.52489
## 10 0.7861 0.481586 0.222033 0.7986 0.55651
\end{verbatim}
...
##        V9       V8     V7      V6
##     <dbl>    <dbl>  <dbl>   <dbl>
##  1 0.6288 0.240864 0.7096 0.04952
##  2 0.8961 0.936968 0.7332 0.55065
##  3 0.8091 0.453242 0.4523 0.84749
##  4 0.7617 0.006659 0.8530 0.59532
##  5 0.9758 0.131051 0.2574 0.19016
##  6 0.8193 0.519675 0.5033 0.68993
##  7 0.2888 0.966405 0.1014 0.29977
##  8 0.0981 0.673018 0.8871 0.09216
##  9 0.3256 0.777429 0.4581 0.52489
## 10 0.7861 0.481586 0.5539 0.55651
\end{verbatim}
...
\subsection{Faktorid}\label{faktorid}
...
\subsubsection{\texorpdfstring{\texttt{fct\_recode()} rekodeerib faktori
...
\subsubsection{\texorpdfstring{\texttt{fct\_collapse()} annab argumenti
...
\subsubsection{\texorpdfstring{\texttt{fct\_lump()} lööb kokku kõik
vähem arv kordi esinevad
...
\subsubsection{Rekodeerime pideva muutuja
...
\subsubsection{Muudame faktori tasemete järjekorda
...
\subsubsection{\texorpdfstring{\texttt{fct\_relevel()} tõstab joonisel
osad tasemed teistest
...
\subsubsection{\texorpdfstring{Joontega plotil saab
...
\subsubsection{\texorpdfstring{Tulpdiagrammide korral kasuta
