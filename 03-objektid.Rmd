...
https://cran.r-project.org/bin/macosx/el-capitan/contrib/3.5/effects_4.0-3.tgz
```{r}
install.packages("https://cran.r-project.org/bin/macosx/el-capitan/contrib/3.5/effects_4.0-3.tgz", repo=NULL, type="source")
library(effects)
...
installed.packages()
updateR(admin_password = "P1hukeha")
```
