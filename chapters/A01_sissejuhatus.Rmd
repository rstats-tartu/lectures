...
plot(iris$Sepal.Width~iris$Sepal.Length, ylim=c(2,8), col=Species)
abline(m1)
```
...
Interaktsioonimudeli koefitsientide tõlgendamine on keerulisem. Hiljem õpime selliseid mudeleid graafiliselt tõlgendama. Mudeli koefitsientide otse tõlgendamine ei ole siin sageli perspektiivikas.

> Interaktsioonimudelis sõltub x1 mõju tugevus Y-le (ehk b1) x2 väärtusest. Selle sõltuvuse määra kirjeldab b3 (x1 & x2 interaktsiooni tugevus). Samamoodi ja sümmeetriliselt erineb ka x2 mõju erinevatel x1 väärtustel. 
