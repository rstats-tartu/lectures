...
Nagu näha, tulemuseks on ikkagi sirge. Veelgi enam, tulemuseks on paralleelne sirge mudeliga y=x1, mille intercept = mean(x2). Muidugi võime me plottida selle mudeli suvalise x2 väärtuse korral või lasta varieeruma hoopis x2 ja fikseerides x1 väärtuse, või plottida 3D mudel, kus nii x1 kui x2 saavad omandada rea väärtusi. Viimasel juhul ei ole enam tegu regressioonisirgega vaid regressioonitasandiga (aga see tasand on laudsirge)
...
Interaktsiooni modelleerime korrutades läbi x1 ja x2 ja andes sellele korrutisele kaalu b3 (antud juhul 0.1).
```{r fig.height=3, fig.width=3}
x1 <-  0:100 
x2 <-  0:100
b3 <- 0.1
...
Nagu näha, interaktsioon viib selleni, et interaktsioonimudeli tõus erineb ilma interaktsioonita mudeli tõusust. Kui see mudel plottida välja 3D-s üle paljude x1 ja x2 väärtuste, saame me 2D regressioonitasapinna, mis on kõver (b3 annab kurvatuuri).
