<<<<<<< HEAD:A03_pidev.Rmd
---
title: "4.7. Ennustame Pidevat suurust"
---
=======

# Ennustame Pidevat suurust
>>>>>>> 4a904f8ff148d8ab5f8c60b29e06a3d7233ab7ee:chapters/A03_pidev.Rmd
...
## 4.7.1 Kui lai on meie tõepärafunktsioon? 
...
### R-i lm() mudeli süntaks

 (+X) lisa see muutuja mudelisse

 (-X) eemalda see muutuja

(X:Z) mudelda interaktsioon X1 ja X2 vahel (y~ x1:x2 tähendab y = a + b1x1x2)

(X*Z) lisa nii X kui Z kui nende vaheline interaktsioon:
  (y ~ x1*x2 tähendab y = a + b1x1 + b2x2 + b3x1x2)
  
(X|Z) lisa X tingimusel, et Z

(y ~ 1) - mudelis on ainult intercept

(y ~ x - 1) - võtab intercepti maha (intercept=0).  y ~ x + 0 ja y ~ 0 + x teevad sedasama.
 
 Hierarhilised mudelid:
 
 (1 / subject)	lase interceptid vabaks igale subjektile 
 
 (1+ time / subject)	lase nii interceptid kui tõusud vabaks subjekti kaupa
...
Mudeli kontekstis tähendavad +, - ja * midagi muud, kui aritmeetikas. Need mudeli osad, kus operaatoreid kasutatakse nende aritmeetilises vormis tuleb panna funktsiooni  I(). Näiteks mudelis y ~ a + I(b+c) on b+c b ja c summa.
...
## 4.13. Mitme prediktoriga lineaarne regressioon
...
### 4.13.1 mudeldamine standardiseeritud andmetega.
...
#### 4.13.2.3. Posterior prediction plots 
