...
Järgmiseks kahe pideva muutuja scatterplot, kus me veel lisaks värvime punktid iiriseliigi järgi.
```{r}
...
3. **geom**-i, mis määrab, mis tüüpi visualiseeringut sa tahad. 
...
Lõpuks toome graafikul eraldi välja neile parimatele autodele. 
