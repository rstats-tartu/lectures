...
2. logaritmi andmed aes()-s: andmed ja teljed on logaritmitud 

```{r}
ggplot(cars, aes(x = log2(speed), y = log2(dist))) + geom_point()
```
...
Ja lõpuks, kui te ikkagi tahate plottida tulpdiagrammi, nii et tulba kõrgus vastaks tabeli ühes lahtris olevale numbrile, mitte faktortunnuse esinemiste arvule tabelis, siis kasuta: `geom_bar(stat = "identity")`
