...
Võrgustik koosneb sõlmedest ja nende vahel olevatest servadest (nodes and edges)
...
Siin on tabeli mtcars kõik korrelatsioonid, mis on suuremad kui absoluutväärtus 0.9-st.
