...
ggplot(midwest_subset, aes(percwhite, percbelowpoverty)) +
  ...
  labs(x = "Percent white", y = "Percent below poverty", caption="sinine joon on kaalutud mudel\npunane joon on tavaline mudel ", title="Vaesusriski seos rassiga")
```
