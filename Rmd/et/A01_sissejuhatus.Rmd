...
Kujutlege katset, kus mõõdame 2000 valgu tasemeid katse-kontroll skeemis (igat katset korratakse n korda). Sageduslik statistik kasutab adjusteeritud p väärtusi (või q väärtusi), et tõmmata piir, kus ühele poole jäävad statistiliselt olulised tulemused (efektid) ja teisele poole mitteolulised null-efektid. Edasi tõlgendab ta vaikimisi mitteolulisi efekte kui ebaolulisi ja diskuteerib vaid nn olulisi efekte (ja sageli neidki valikuliselt). Paraku, kuna p väärtuste arvutamine ja adjusteerimine saab toimida mitmel erineval moel ja usalduspiiri panekule 95-le protsendile, mitte näiteks 89%, pole ühtegi ratsionaalset põhjendust, siis tähendab see sisuliselt, et ta järjestab oma tulemused efekti suuruse järgi, seejärel tõmbab neist maha mõned, mille katsest-katsesse varieeruvus on suurem kui teistel (sageli väiksest valimist tuleneva juhusliku müra tõttu) ja lõpuks tõmbab juslikus kohas joone läbi efektide, misjärel ta ignoreerib kõiki juhuslikust joonest valele poole jäänud efekte.
