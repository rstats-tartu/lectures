...
3. ava RStudio (R ise töötab taustal)
...
Üleval vasakul on sinu poolt nimega varustatud r script (laiend .R). Sinna kirjutad oma koodi ja kommentaarid sellele. Leia selle kohalt nupp Run. Kirjuta scripti aknasse 2 + 2, jäta kursor sellele reale ja vajuta Run nuppu. Leia output alt vasakult konsoolist. Nüüd kirjuta 2 + 3, jäta kursor sellele reale ja vajuta cmd + Enter. Leia konsoolist output.

All vasakul on konsool. Seal jookseb su kood sinna ja sinna tekib osaliselt output.

Üleval paremal on Environment. Seal on näha R-i objektid, mis on sulle worspaces kättesaadavad ja millega sa saad töötada. Kohe varsti õpime, kuidas objekte juurde tekitada ja Environmenti saata.
