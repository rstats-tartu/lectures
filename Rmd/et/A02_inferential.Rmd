...
b <- rep(1:nr_boot_samples, each = n) #create a column that cuts the sample into slices of size n
...
esimene patsient suri - 0 mortaalsus ei ole enam loogiliselt võimalik (välja arvatud siis kui prior selle koha peal = 0).
...
Kolmas patsient jäi ellu - 0 ja 100% mortaalsus on võimaluste nimekirjast maas.
